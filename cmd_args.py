...
dataset_names = ['LFW', 'CASIA', 'LFW_CROP', 'FFHQ', 'CELEBA']
...
def define_parser():
    ...
    parser.add_argument('--data_root', default=osp.expanduser('/mnt/03a7b3b6-14f4-4a74-958b-71dd6cdd09bc/dataset'), help='path to dataset')
    parser.add_argument('--save_dir', default='', help='path to save')
    parser.add_argument('--data_dir_type',type=int, default=1, help='2 or 3 layers')
